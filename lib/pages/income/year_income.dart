                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            TopMenuItemCard(title: 'Monthly Income', subTitle: value.dateWiseTransactionTotal('Income','month').toString(), active: false, onTapFunction: () {
                              Navigator.of(context)
                                  .pushReplacementNamed('/income/month_income');
                            },),
                            const SizedBox(
                              width: 10,
                            ),
                            TopMenuItemCard(title: 'Yearly Income', subTitle: value.dateWiseTransactionTotal('Income','year').toString(), active: true, onTapFunction: () { },),
                          ]
                      )
                  ),
                  //
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: value.dateWiseTransactionList('year').isEmpty
                        ...
                        itemBuilder: (context, index) => value.dateWiseTransactionList('year')[index].type == 'Income' ? ExpenseTiles(
                          ...
                          deleteTapped: (p0) => deleteIncome(value.dateWiseTransactionList('year')[index]),
