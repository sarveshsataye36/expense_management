...
class WeekIncome extends StatefulWidget {
  const WeekIncome({super.key});

  @override
  State<WeekIncome> createState() => _WeekIncomeState();
}

class _WeekIncomeState extends State<WeekIncome> {
  // text controller
        ...
        child: Consumer<ExpenseData>(builder: (context, value, child)=>Scaffold(
            ...
            body: Padding(
                ...
                child: Column(children: [
                  ...
                  SingleChildScrollView(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            TopMenuItemCard(title: 'Weekly Income', subTitle: value.dateWiseTransactionTotal('Income','week').toString(), active: true, onTapFunction: () { },),
                            const SizedBox(
                              width: 10,
                            ),
                  ...
                  const ComponentTitle(title: 'Week Income List'),
                  const SizedBox(
                    height: 20,
                  ),
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: value.dateWiseTransactionList('week').isEmpty
                        ...
                        itemBuilder: (context, index) => value.dateWiseTransactionList('week')[index].type == 'Income' ? ExpenseTiles(
                          ...
                          deleteTapped: (p0) => deleteIncome(value.dateWiseTransactionList('week')[index]),
