...
class ExpenseTilesAnalysis extends StatelessWidget {
  final String expenseName;
  final String expenseAmount;
  final String type;
  final DateTime expenseDateTime;
  final expenseCurd = ExpenseCurd();
  ExpenseTilesAnalysis({super.key, required this.expenseName, required this.expenseAmount, required this.expenseDateTime,required this.type});
